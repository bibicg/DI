...
class MainMenu:
    ...
    def __init__(self, root, start_game_callback, show_stats_callback, quit_callback):
        ...
        self.btn_jugar = tk.Button(self.root, text="Jugar", font=("Calibri", 18), fg="white", bg="black",
                                   command=start_game_callback)
        self.btn_jugar.pack(pady=20)

        self.btn_stats = tk.Button(self.root, text="Ver estadísticas", font=("Calibri", 18), fg="white", bg="black",
                                   command=show_stats_callback)
        self.btn_stats.pack(pady=20)

        self.btn_exit = tk.Button(self.root, text="Salir", font=("Calibri", 18), fg="white", bg="black",
