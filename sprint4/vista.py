...
class GameView(tk.Toplevel):
    ...
    def create_board(self, model):
        # Crea la ventana de juego como una instancia de Toplevel, estableciendo su título y usando el modelo (modelo)
...
class MainMenu:
    ...
    def show_difficulty_selection(self, player_name):
        ...
        difficulties = [("Fácil (4x4)", "facil"), ("Intermedio (6x6)", "intermedio"), ("Difícil (8x8)", "dificil")]
