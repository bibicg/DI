...
class GameModel:
    ...
    def __init__(self, size, nombre_jugador, cell_size=100):
        # Incialización:
        self.size = size
    ...
    def _generate_board(self):
        ...
        random.shuffle(card_ids) # metodo para mezclar aleatoriamente los id de las cartas
        self.board = card_ids
    ...
    def save_score(self):
        ...
        try:
            ...
            score_data = f"{self.nombre_jugador}, {self.difficulty}, {self.moves}, {self.get_time()}, {date}\n"
